...
- The public GitHub repository and tagged preview release exist. Windows and macOS ZIP digests match the release metadata. Next: correct checksum filenames for direct verification, then recheck release assets.
